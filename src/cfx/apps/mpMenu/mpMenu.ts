...
// Thêm kiểm tra và định nghĩa fallback cho invokeNative
if (typeof nuiWindow.invokeNative !== 'function') {
  nuiWindow.invokeNative = (native: string, arg: string) => {
    console.warn(`invokeNative called with ${native} and ${arg}, but not implemented`);
  };
}
